defmodule Day6Test do
  ...
  # The map shows the current position of the guard with ^ (to
  # indicate the guard is currently facing up from the perspective
  # of the map). Any obstructions - crates, desks, alchemical
  ...
  # degrees. Otherwise, take a step forward. Following the above
  # protocol, the guard moves up several times until she reaches
  ...
  test "number of unique positions" do
    map = [
      "....#.....",
      ".........#",
      "..........",
