defmodule Day3Test do
  ...
  # mul(2,4), mul(3,7), mul(11,8), and mul(8,5).
  # Adding up the result of each instruction produces:
  # 161 (2*4 + 5*5 + 11*8 + 8*5).

  test "processes the uncorrupted instructions" do
  ...
  # don't() instruction before them.
  # The other mul instructions function
  # normally, including the one at the end that gets re-enabled by a do()
  # instruction.

  # This time, the sum of the results is 48 (2*4 + 8*5).

  test "obeying do and don't instructions" do
